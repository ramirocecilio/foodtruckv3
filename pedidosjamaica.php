...
<form method="POST" action="pedidosjamaica.php" class="needs-validation" novalidate>
<div class="form-row">
  <div class="col-md-4 mb-3">
    <label for="validationCustom01" class="text" >Nombre: </label>
    <input name="nombreJ" type="text" class="form-control" id="validationCustom01" value="" required>
...
<div class="form-row">
  <div class="col-md-6 mb-3">
    ...
    <input name="direcJ" type="text" class="form-control" id="validationCustom03" required>
    <div class="invalid-feedback">
      Please provide a valid city.
    </div>
  </div>
</div>
<h2 for="validationCustom03" class="text" >precio: $20 </h2>
<button class="btn btn-primary" type="submit">Submit form</button>
</form>';
error_reporting(E_ERROR | E_PARSE);
$nombre=$_POST["nombreJ"];
$direc=$_POST["direcJ"];
$orden="Agua de jamaica";
$precio="$20";
if($nombre  ==  "" || $direc == "")
{
