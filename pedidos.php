...
<form method="POST" action="pedidos.php" class="needs-validation" novalidate>
<div class="form-row">
  <div class="col-md-4 mb-3">
    <label for="validationCustom01" class="text" >Nombre: </label>
    <input type="text" name="nombreTACOS" class="form-control" id="validationCustom01" value="" required>
...
<div class="form-row">
  <div class="col-md-6 mb-3">
    ...
    <input type="text" name="DirecTACOS" class="form-control" id="validationCustom03" required>
...
$nombre=$_POST["nombreTACOS"];
$direc=$_POST["direcTACOS"];
$orden="tacos de pastor";
$precio="$10";
if($nombre  ==  "" || $direc == "")
{
